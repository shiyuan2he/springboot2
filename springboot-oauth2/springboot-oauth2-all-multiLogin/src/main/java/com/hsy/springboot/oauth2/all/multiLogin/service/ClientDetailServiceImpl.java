package com.hsy.springboot.oauth2.all.multiLogin.service;//package com.hsy.springboot.oauth2.server;
import com.hsy.springboot.oauth2.all.multiLogin.bean.entity.TOauthClient;
import com.hsy.springboot.oauth2.all.multiLogin.enums.Oauth2TypeEnum;
